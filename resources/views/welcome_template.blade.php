                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <div class="contacts-list-info">
                                                                ...
                                                                <span class="contacts-list-msg">How
                                                                    have you been? I was...</span>
                                                            </div>
                                                            <!-- /.contacts-list-info -->
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <div class="contacts-list-info">
                                                                ...
                                                                <span class="contacts-list-msg">Where
                                                                    is your new...</span>
                                                            </div>
                                                            <!-- /.contacts-list-info -->
                                                        </a>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="{{ asset('template/pages/examples/invoice.html') }}">OR9842</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a href="{{ asset('template/pages/examples/invoice.html') }}">OR1848</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a href="{{ asset('template/pages/examples/invoice.html') }}">OR7429</a>
                                                    </td>
                                                    <td>iPhone 6 Plus</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="chart-legend clearfix">
                                                <li><i class="far fa-circle text-danger"></i> Chrome
                                                </li>
                                                <li><i class="far fa-circle text-success"></i> IE</li>
                                                <li><i class="far fa-circle text-warning"></i> FireFox
                                                </li>
                                                <li><i class="far fa-circle text-info"></i> Safari
                                                </li>
                                                <li><i class="far fa-circle text-primary"></i> Opera
                                                </li>
