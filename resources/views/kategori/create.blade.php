        ...
        <div class="card-body">
            <form method="POST" action="{{ url('kategori') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="text" class="form-control" id="kategori_kode" name="kategori_kode"
                            value="{{ old('kategori_kode') }}" placeholder="Masukkan Kategori Kode" required>
                        @error('kategori_kode')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="text" class="form-control" id="kategori_nama" name="kategori_nama" value="{{ old('kategori_nama') }}" placeholder="Masukkan Kategori Nama" required>
                        @error('kategori_nama')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
